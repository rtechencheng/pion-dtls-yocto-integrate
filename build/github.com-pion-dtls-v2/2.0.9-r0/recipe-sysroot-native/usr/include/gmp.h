...
#define __GMP_CC "gcc "
#define __GMP_CFLAGS "-O2 -pedantic -fomit-frame-pointer -m64 -mtune=k8 -march=k8 -isystem/home/chencheng/workspace/wittra/repos/wittra-gateway/yocto/build/tmp-glibc/work/aarch64-wittra-linux/github.com-pion-dtls-v2/2.0.9-r0/recipe-sysroot-native/usr/include -O2 -pipe"
